...
curl -O https://raw.githubusercontent.com/cloudshell123/labtest/master/Files/DisablePasswordComplexity.ps1 > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\Fast Config VPS.exe" https://raw.githubusercontent.com/cloudshell123/labtest/master/Files/FastConfigVPS_v5.1.exe > out.txt 2>&1
curl -o "C:\Users\Public\Desktop\EVKey Vietnamese Keyboard.exe" https://raw.githubusercontent.com/cloudshell123/labtest/master/Files/EVKey64.exe > out.txt 2>&1
